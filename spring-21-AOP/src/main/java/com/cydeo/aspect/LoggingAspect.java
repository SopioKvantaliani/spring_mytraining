...
@Aspect //we need to to put this annotation
@Component
public class LoggingAspect {

    Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
    //it is giving us logger object.
    //it is used to print something on console, but we'll see another usage as well.
    //it is most popular one in the market.

//    @Pointcut("execution(* com.cydeo.controller.CourseController.*(..))")
//    public void myPointcut() {}
//
//    @Before("myPointcut()") //this method runs before any method inside the CourseController
//    public void log() {
