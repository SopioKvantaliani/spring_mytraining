...
public class Consume_WebClient {
    ...
    @GetMapping("/flux-movie-cinemas")//localhost:8080/flux-movie-cinemas --> I am consuming my own API.
    public Flux<MovieCinemaDTO> readAllCinemaFlux(){ //Flux returns more than one movieCinema DTO. It works reactive way, a-synchronized way
...
//    }
    ...
    @GetMapping("/mono-movie-cinema/{id}")
    public ResponseEntity<Mono<MovieCinemaDTO>> readById(@PathVariable("id") Long id){ //only return one object = Mono
